...
def main():
    ...
    used_ip_str_path = r'D:\xuexi\cheshiwenjian\新IP表.txt'
    print(used_ip_str_path)

    # usable_ip_str_path = input('可用IP范围文件路径：')
    usable_ip_str_path = r'D:\xuexi\cheshiwenjian\原IP表.txt'
    print(usable_ip_str_path)

    # not_used_ip_str_path = input('未使用IP输出文件路径：')
    not_used_ip_str_path = r'D:\xuexi\cheshiwenjian\不包含IP.txt'
