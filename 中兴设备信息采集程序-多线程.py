...
def collect_analysis(ip_item, dev_list):
    ...
    if float(version_id) < 3.0:
        ...
        optical_file_path = rf'D:\xuexi\cheshiwenjian\{ip_item[0]}-optical-log-{now}.txt'
        ...
        flow_file_path = rf'D:\xuexi\cheshiwenjian\{ip_item[0]}-flow-log-{now}.txt'
        output_file(flow_file_path, flow_log_str)
        intf_desc_file_path = rf'D:\xuexi\cheshiwenjian\{ip_item[0]}-intf-desc-log-{now}.txt'
...
read_file_path = r'D:\xuexi\cheshiwenjian\中兴设备IP地址.txt'
